...
export default defineConfig(
  // Ignored paths
  {
    ignores: [
      '**/dist/**',
      // Publish staging: a copy of the built dashboard, generated by
      // scripts/prepare-publish.mjs. Minified bundles, never linted.
      'apps/daemon/ui-dist/**',
      '**/node_modules/**',
      '**/coverage/**',
  ...
  // Repo tooling scripts: Node.js globals
  {
